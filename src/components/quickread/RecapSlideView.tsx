    ...
    <div className="h-full overflow-y-auto bg-paper">
      <div className="flex min-h-full flex-col items-center justify-between gap-3 p-[6%] text-center sm:p-[7%]">
        <div className="flex w-full flex-1 flex-col items-center justify-center gap-3">
          <div className="flex h-[clamp(40px,11vw,54px)] w-[clamp(40px,11vw,54px)] items-center justify-center rounded-full bg-ink font-heading text-[clamp(18px,5vw,26px)] text-accent-yellow">
            ✓
          </div>
          <h2 className="font-heading text-[clamp(20px,6.5vw,30px)] font-bold leading-tight text-ink">
            {slide.heading}
          </h2>
          ...
          <div className="flex w-full flex-col gap-1.5">
            {slide.items.map((item, i) => (
              <div
                key={i}
                className="flex items-center gap-2 rounded-md bg-white px-[4%] py-[2.5%] text-left shadow-sm"
              >
                ...
                <span className="font-heading text-[clamp(12px,3.2vw,15px)] font-semibold text-ink">
                  {item}
                </span>
              </div>
            ))}
        ...
        <div className="w-full rounded-lg bg-ink p-[4%]">
