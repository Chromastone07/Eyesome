  ...
  return (
    <div className="h-full overflow-y-auto bg-paper">
      <div className="flex min-h-full flex-col gap-3 p-[6%] sm:p-[7%]">
        ...
        <h2 className="font-heading text-[clamp(22px,7vw,34px)] font-bold leading-[1.1] text-ink">
          {renderHeading(
            slide.heading,
            slide.highlight,
        ...
        <div className="flex flex-1 flex-col gap-3">
          {slide.cards.map((card, i) => (
            <div
              key={i}
              className={`flex flex-1 flex-col gap-1.5 rounded-lg border-l-4 bg-white p-[4%] shadow-sm ${
            ...
            >
              ...
              <p className="font-body text-[clamp(11px,2.8vw,12.5px)] leading-relaxed text-ink/65">
                {card.body}
              </p>
            </div>
          ))}
